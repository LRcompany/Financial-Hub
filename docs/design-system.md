...
- **Popup de detalhe (hover)**: estilo glass (`--glass-bg`/`--glass-blur`/`--glass-border`), aparece só quando há dado real pra mostrar (nunca um campo vazio/traço) — ver `AssetHoverDetails` em `Patrimonio.tsx`.
