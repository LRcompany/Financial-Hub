...
- [ ] Modal de "registrar aporte" — seleciona ativo existente (já traz corretora/moeda) ou cria ativo/corretora novo; salva como delta no `investedAmount` travado (com histórico). Ver "Segundo bug achado... câmbio vazando pro investido da Nomad" acima.
- [ ] Divergência Eletrobras (AXIA3/6/7/11/13/14) e Copel (CPLE3 vs CPLE6) entre a planilha real e o banco — parece corporate action/reorganização de classe de ação, não bug de câmbio. Ver seção acima.
