...
- [ ] Auditoria de valor errado (dólar em vez de reais) em OUTRAS assinaturas internacionais (ver "Bug sério: valor de compra internacional..." acima) — só Google Workspace foi conferido e corrigido retroativamente (13 meses, R$379,78 de diferença). Candidatos a checar se algum fatura em moeda estrangeira: Claude, Adobe, Apple, Digital Ocean. O código já está corrigido pra qualquer um deles daqui pra frente; falta só auditar o histórico.
